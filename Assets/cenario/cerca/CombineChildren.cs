//originalcode: http://grrava.blogspot.be/2014/08/combine-meshes-in-unity.html
...
public class CombineChildren : MonoBehaviour {
 ...
 void Start()
 {
  ...
  foreach(var filter in meshFilters)
  {
   ...
   //filter.GetComponent<Renderer>().SetActive(false);
   Destroy(filter.GetComponent<Renderer>());
  }
