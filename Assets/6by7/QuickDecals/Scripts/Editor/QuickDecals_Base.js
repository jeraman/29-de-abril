...
class QuickDecals_Base extends EditorWindow 
{
	...
	function PlaceNewDecal(hitInfo : RaycastHit)
	{
		...
		newDecal = Instantiate((AssetDatabase.LoadAssetAtPath("Assets/6by7/QuickDecals/DecalMesh/DecalMeshObject.fbx", typeof(Object))), Vector3.zero, Quaternion.identity);
